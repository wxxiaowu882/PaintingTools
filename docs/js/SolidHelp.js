        ...
        <div id="solid-global-help-modal">
            <div class="solid-help-panel">
                ...
                <div class="solid-help-content">
                    ...
                    <h3>童画师解析</h3>
                    <p>进入场景后，<b>第一件事</b>：点开<b>童画师解析</b>。页面<b>右上角</b>，三条横线菜单按钮的<b>正下方</b>，有一个<b>黄色圆标、书页图标</b>的按钮——那就是它（不是「?」操作指南下方）。</p>
                    <p>这里是童画师吴晓为本场景写的<b>必看知识正文</b>，也是整场的<b>知识中枢</b>：这个场景在学什么、怎么理解、和前后场景怎么衔接，都以这里为准。场景里的物体、标注、光影氛围等，都是围着解析里的知识来配合的——一切是为解析中要讲的知识服务。解析可以反复打开对照。</p>
                    ...
                    <h3>标注</h3>
                    <p>为了让你吃透光影关系和造型规律，我们加了各种指示标注。点击标注可以在页面左上角看到更详细的解释。</p>
                    ...
                    <h3>场景切换</h3>
                    <p>点击左上角的"学习场景"按钮，可以呼出弹窗，切换不同的学习场景。建议按顺序从头看，前后的知识是连着的。换场景后，童画师解析正文会一起换——每个场景的知识中枢都不同，进新场景后请重新点开阅读。</p>
                </div>
            </div>
        </div>
    `;
