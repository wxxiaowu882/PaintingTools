/**
 * Vendored/adapted from google/xrblocks samples/avatar_lab/gnm/GNMModel.js
 * (Apache-2.0). GNM (Generative aNthropometric Model) © Google LLC.
 *
 * GNMModel.js — JavaScript port of the GNM head forward function,
 * mirroring gnm/shape/gnm_common.py:
 *
